...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_DAC_generator is
  ...
  signal address0 : STD_LOGIC_VECTOR ( 6 downto 1 );
  ...
  signal address1_carry_i_17_n_0 : STD_LOGIC;
  ...
  signal \address_reg_rep_rep[6]_i_2_n_3\ : STD_LOGIC;
  signal \address_reg_rep_rep[6]_i_2_n_4\ : STD_LOGIC;
  signal \address_reg_rep_rep[6]_i_2_n_5\ : STD_LOGIC;
  signal \address_reg_rep_rep[6]_i_2_n_6\ : STD_LOGIC;
  signal \address_reg_rep_rep[6]_i_2_n_7\ : STD_LOGIC;
  ...
  signal \address_rep_rep[6]_i_3_n_0\ : STD_LOGIC;
  signal \address_rep_rep[6]_i_4_n_0\ : STD_LOGIC;
  signal \address_rep_rep[6]_i_5_n_0\ : STD_LOGIC;
  signal \address_rep_rep[6]_i_6_n_0\ : STD_LOGIC;
  signal \address_rep_rep[6]_i_7_n_0\ : STD_LOGIC;
  signal \address_rep_rep[6]_i_8_n_0\ : STD_LOGIC;
  ...
  signal \NLW_address1_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 to 7 );
  ...
  signal \NLW_address_reg_rep_rep[6]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 5 );
  signal \NLW_address_reg_rep_rep[6]_i_2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 6 );
  attribute COMPARATOR_THRESHOLD : integer;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \address_rep_rep[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \address_rep_rep[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \address_rep_rep[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \address_rep_rep[4]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \address_rep_rep[5]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \address_rep_rep[6]_i_1\ : label is "soft_lutpair4";
begin
address1_carry: unisim.vcomponents.CARRY8
     port map (
      CI => address1_carry_i_1_n_0,
      CI_TOP => '0',
      ...
      DI(7) => address1_carry_i_2_n_0,
      DI(6) => address1_carry_i_3_n_0,
      DI(5) => address1_carry_i_4_n_0,
      DI(4) => address1_carry_i_5_n_0,
      DI(3) => address1_carry_i_6_n_0,
      DI(2) => address1_carry_i_7_n_0,
      DI(1) => address1_carry_i_8_n_0,
      DI(0) => address1_carry_i_9_n_0,
      O(7 downto 0) => NLW_address1_carry_O_UNCONNECTED(7 downto 0),
      S(7) => address1_carry_i_10_n_0,
      S(6) => address1_carry_i_11_n_0,
      S(5) => address1_carry_i_12_n_0,
      S(4) => address1_carry_i_13_n_0,
      S(3) => address1_carry_i_14_n_0,
      S(2) => address1_carry_i_15_n_0,
      S(1) => address1_carry_i_16_n_0,
      S(0) => address1_carry_i_17_n_0
    );
\address1_carry__0\: unisim.vcomponents.CARRY8
     port map (
      CI => address1_carry_n_0,
      CI_TOP => '0',
      CO(7) => \NLW_address1_carry__0_CO_UNCONNECTED\(7),
      CO(6) => address1,
      ...
      DI(7) => '0',
      DI(6) => \address1_carry__0_i_1_n_0\,
      DI(5) => \address1_carry__0_i_2_n_0\,
      DI(4) => \address1_carry__0_i_3_n_0\,
      DI(3) => \address1_carry__0_i_4_n_0\,
      DI(2) => \address1_carry__0_i_5_n_0\,
      DI(1) => \address1_carry__0_i_6_n_0\,
      DI(0) => \address1_carry__0_i_7_n_0\,
      O(7 downto 0) => \NLW_address1_carry__0_O_UNCONNECTED\(7 downto 0),
      S(7) => '0',
      S(6) => \address1_carry__0_i_8_n_0\,
      S(5) => \address1_carry__0_i_9_n_0\,
      S(4) => \address1_carry__0_i_10_n_0\,
      S(3) => \address1_carry__0_i_11_n_0\,
      S(2) => \address1_carry__0_i_12_n_0\,
      S(1) => \address1_carry__0_i_13_n_0\,
      S(0) => \address1_carry__0_i_14_n_0\
    );
...
address1_carry_i_16: unisim.vcomponents.LUT2
    generic map(
      ...
      I1 => address_reg_rep(4),
      O => address1_carry_i_16_n_0
    );
address1_carry_i_17: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => address_reg_rep(3),
      I1 => address_reg_rep(2),
      O => address1_carry_i_17_n_0
    );
...
\address_reg_rep[7]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\address_reg_rep_rep[6]_i_2\: unisim.vcomponents.CARRY8
     port map (
      CI => address_reg_rep(0),
      CI_TOP => '0',
      CO(7 downto 5) => \NLW_address_reg_rep_rep[6]_i_2_CO_UNCONNECTED\(7 downto 5),
      CO(4) => \address_reg_rep_rep[6]_i_2_n_3\,
      CO(3) => \address_reg_rep_rep[6]_i_2_n_4\,
      CO(2) => \address_reg_rep_rep[6]_i_2_n_5\,
      CO(1) => \address_reg_rep_rep[6]_i_2_n_6\,
      CO(0) => \address_reg_rep_rep[6]_i_2_n_7\,
      DI(7 downto 5) => B"000",
      DI(4 downto 0) => address_reg_rep(5 downto 1),
      O(7 downto 6) => \NLW_address_reg_rep_rep[6]_i_2_O_UNCONNECTED\(7 downto 6),
      O(5 downto 0) => address0(6 downto 1),
      S(7 downto 6) => B"00",
      S(5) => \address_rep_rep[6]_i_3_n_0\,
      S(4) => \address_rep_rep[6]_i_4_n_0\,
      S(3) => \address_rep_rep[6]_i_5_n_0\,
      S(2) => \address_rep_rep[6]_i_6_n_0\,
      S(1) => \address_rep_rep[6]_i_7_n_0\,
      S(0) => \address_rep_rep[6]_i_8_n_0\
    );
...
\address_rep_rep[6]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => address_reg_rep(6),
      O => \address_rep_rep[6]_i_3_n_0\
    );
\address_rep_rep[6]_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => address_reg_rep(5),
      O => \address_rep_rep[6]_i_4_n_0\
    );
\address_rep_rep[6]_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => address_reg_rep(4),
      O => \address_rep_rep[6]_i_5_n_0\
    );
\address_rep_rep[6]_i_6\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => address_reg_rep(3),
      O => \address_rep_rep[6]_i_6_n_0\
    );
\address_rep_rep[6]_i_7\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => address_reg_rep(2),
      O => \address_rep_rep[6]_i_7_n_0\
    );
\address_rep_rep[6]_i_8\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => address_reg_rep(1),
      O => \address_rep_rep[6]_i_8_n_0\
    );
